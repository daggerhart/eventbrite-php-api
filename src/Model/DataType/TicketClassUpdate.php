...
class TicketClassUpdate extends \Eventbrite\Model\DataType\TicketClassCreate
{
    /**
     * Image ID for this ticket class. Setting this to null will remove image from this ticket class.
     *
     * @var string|null
     */
    ...
    /**
     * Unsigned number in the order ticket classes are sorted by.
     *
     * @var int|null
     */
    public ?int $sorting;
